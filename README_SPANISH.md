El código licenciado aquí bajo la GNU Affero General Public License, versión 3 [AGPL-3.0](http://www.gnu.org/licenses/agpl-3.0.html) ha sido desarrollado por el equipo de Goteo bajo la dirección de Platoniq y cedido posteriormente a la Fundación Goteo, tal como se detalla en http://www.goteo.org/about#info6
...
Para la implementación de subdominios funcionales de la plataforma en modalidad de nodo autónomo de Goteo (esto es, alojados en servidor de la Fundación Goteo y adaptados para gestión independiente por parte de otras entidades o colectivos, que puedan garantizar la articulación mínima de recursos para su correcto funcionamiento) recomendamos contactar mediante la siguiente dirección de correo electrónico: info[arroba]goteo.org
