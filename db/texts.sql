...
('blog-main-header', 'nl', 'Goteo Blog'),
...
('call-splash-invest_explain', 'nl', 'Voor elke <strong>1&euro;</strong> die je geeft aan een project in Goteo.org, geeft <strong>%s</strong>  een <strong>1&euro;</strong> aan hetzelfde project.'),
...
('faq-main-section-header', 'nl', 'Een benadering van Goteo'),
...
('feed-new_call-opened', 'nl', '<span class="red">Nieuwe oproep in Goteo</span>, je project can nu meedoen'),
...
('feed-new_project', 'nl', '    <span class="red">Nieuw Goteo project</span>, je hebt 40 dagen om dit project te steunen.'),
...
('feed-new_user', 'nl', 'Nieuwe Goteo gebruiker, %s'),
...
('form-project_waitfor-cancel', 'nl', 'We hebben besloten je voorstel niet te publuceren op Goteo, maar we moedigen je aan om het nog eens te proberen met een ander idee of concept.'),
...
('form-project_waitfor-review', 'nl', 'We nemen contact met je op zodra we de kans hebben gehad om je project te beoordelen. Dan zullen ofwel je project toevoegen ofwel je suggesties doen over hoe je het beter op Goteo kunt laten passen.'),
...
('guide-dashboard-user-access', 'nl', 'Je kunt de informatie veranderen waarmee je in kunt loggen op Goteo.'),
...
('guide-dashboard-user-personal', 'nl', 'Je moet deze informatie alleen invullen als je een project hebt gecreeerd dat je gecofinancierd wilt hebben via Goteo. De informatie in deze sectie is noodzakelijk zodat we contact met je op kunnen nemen als je de nodige cofinanciering hebt bereikt, en je het geld kunnen overmaken.'),
...
('guide-dashboard-user-profile', 'nl', 'Of je nou je eigen project wilt aanmaken of een project van iemand anders wilt steunen, om je bij Goteo aan te sluiten raden we je aan om je presentatietekst zorgvuldig te bewerken en relevante links bij te voegen over wat je doet, en een profielafbeelding om je mee te identificeren'),
...
('guide-project-description', 'nl', '<strong>Gebruik deze sectie voor uitleg over het project</strong><br><br>Dit is het eerste dat een bezoeker ziet. Om die reden raden we aan om zorgvuldig te schrijven en typefouten te vermijden. Je zult zien dat er verplichte velden zijn, inclusief die voor video en afbeeldingen. We vinden dat deze essentieel zijn voor het starten van een campagne om fondsen te werven via Goteo.<br><br>Houd in gedachten wat het meest waardevolle van Goteo is: de open informatie en de kennis die je project gaat brengen aan de samenleving, de originaliteit, het verlangen om een bijdrage te leveren aan de maatschappij, het vermogen om een brede gemeenschap van geinteresseerde mensen aan te trekken, duidelijk makend dat het promotieteam de capaciteiten heeft om het project tot bloei te brengen. Dus vergeet niet ons informatie te geven over deze aspecten.'),
...
('guide-project-updates', 'nl', '<b>Het is heel belangrijk dat projecten hun cofinanciers en andere potentieel geinteresseerde mensen op de hoogte houden van de voortgang van de campagne. Gebruik deze sectie als een blog om nieuws over je project te publiceren.</b>Op Goteo, nadat je de minimum financing bereikt hebt, en als je de tweede ronde in gaat, is het essentieel om periodiek uit te leggen hoe de productie, het proces, problemen etc. gaan, om de hoogst mogelijke transparatie en nog meer aandacht te genereren.'),
...
('leave-process-fail', 'nl', 'Het is ons niet gelukt je account te sluiten. Neem even contact met ons op via hola@goteo.org'),
...
('login-banner-header', 'nl', '    Krijg toegang tot de <br /><span class="greenblue">100% open</span> Goteogemeenschap'),
...
('mailer-baja', 'nl', 'Als je geen nieuws meer wilt ontvangen van Goteo.org, kun je je emailadres afmelden via <a href="%s">link</a>'),
...
('mailer-disclaimer', 'en', 'Goteo is a digital platform for collective financing, collaboration and distribution of rewards for the development of social, cultural, educational and technical projects that contribute to the common good and are open source and free knowledge.'),
('mailer-disclaimer', 'nl', 'Goteo is een digitaal platform voor collectieve financiering, samenwerking en distributie van beloningen voor het ontwikkelen van sociale, culturele, educatieve en technische projecten die bijdragen aan het algemeen belang en die open source en open kennis zijn.'),
...
('mandatory-project-field-media', 'nl', 'We raden je aan een video te uploaden om de evaluatie van je project door het Goteo team te faciliteren.'),
...
('newsletter-block', 'en', 'Don''t want any more news from Goteo?<br />You can block the next newsletters in het menu ''My Profile > Preferences'' or <a href="http://www.goteo.org/dashboard/profile/preferences">preferences panel</a>.'),
('newsletter-block', 'nl', 'Wil je geen nieuws meer van Goteo ontvangen?<br />Je kunt de volgende nieuwsbrief blokkeren in het menu ''Mijn profiel > Voorkeuren'' of <a href="http://www.goteo.org/dashboard/profile/preferences">voorkeuren menu</a>.'),
...
('node-footer-help-why', 'en', 'How is Goteo different?'),
('node-footer-help-why', 'nl', 'Wat is er anders aan Goteo?'),
...
('oauth-goteo-openid-sync-password', 'nl', 'Je probeert te verbinden met een bestaand Goteo account met een externe provider. Dat stelt je in staat met Goteo te verbinden met een enkele klik.<br>Deze keer moet je je indentiteit bevestigen met je Goteo wachtwoord.'),
...
('oauth-goteo-user-not-exists', 'nl', 'Die gebruiker bestaat niet in Goteo'),
...
('oauth-goteo-user-password-exists', 'en', 'Die gebruiker bestaat al in Goteo'),
...
('oauth-login-welcome-from', 'nl', 'Welkom bij Goteo. Controleer je gebruikersnaam en email om het proces af te maken. In het geval dat we het emailadres niet hebben kunnen importeren (of als je het veranderd hebt) sturen we een email met een activaitelink.'),
...
('profile-field-contribution', 'nl', 'Wat heb je Goteo te bieden?'),
...
('profile-my_worth-header', 'nl', 'Mijn flow op Goteo'),
...
('project-spread-social', 'en', 'I co-finance the project %s at Goteo.org'),
('project-spread-social', 'nl', 'Ik co-financier het project %s op Goteo.org'),
...
('regular-header-about', 'nl', 'Over Goteo'),
...
('regular-header-glossary', 'en', 'Overzicht van gebruikte termen in Goteo'),
...
('regular-main-header', 'nl', 'Goteo.org'),
...
('regular-share-facebook', 'nl', 'Goteo op Facebook'),
...
('social-account-facebook', 'nl', 'http://www.facebook.com/pages/Goteo/268491113192109'),
...
('social-account-google', 'nl', 'https://plus.google.com/b/116559557256583965659/'),
...
('social-account-twitter', 'nl', 'http://twitter.com/goteofunding'),
...
('tooltip-dashboard-user-change_email', 'nl', 'Verander het emailadres waarop je berichten van Goteo wilt ontvangen.'),
...
('tooltip-dashboard-user-change_password', 'nl', 'Veran der het wachtwoord waarmee je op Goteo wilt inloggen.'),
...
('tooltip-dashboard-user-confirm_email', 'nl', 'Bevesting het emailadres waarop je berichten van Goteo wilt ontvangen.'),
...
('tooltip-dashboard-user-confirm_password', 'nl', 'Bevestig het wachtwoord waarmee je in wilt loggen op Goteo.'),
...
('tooltip-dashboard-user-new_email', 'nl', 'Specificeer het nieuwe emailadres waarop je berichten van Goteo wilt ontvangen.'),
...
('tooltip-dashboard-user-new_password', 'nl', 'Voer een nieuw wachtwoord in waarmee je in wilt loggen op Goteo'),
...
('tooltip-project-category', 'nl', 'Kies zoveel categorieen als je nodig hebt om het project te omschrijven, gebaseerd op wat je hierboven hebt geschreven. Je keuzes helpen ons Goteo gebruikers te interesseren voor je project.'),
...
('tooltip-project-comment', 'nl', 'Heb je twijfels of vragen voor de Goteo beheerder? Dit is de plek om te schrijven over wat je niet zeker weet, verbeteringen etc.'),
...
('tooltip-project-contract_data', 'nl', 'Of het nou een persoon of een rechtsvorm is, iemand moet benoemd worden tot projectpromotor, en als contactpersoon voor Goteo. Het hoeft niet dezelfde te zijn als het gebruikersprofiel in het vorige veld.'),
...
('tooltip-project-contract_email', 'nl', 'Hoofdemailadres geassocieerd met het project. Je zult alle notificaties van het Goteo team op dit adres ontvangen.'),
...
('tooltip-project-costs', 'nl', 'Hoe preciezer je de kosten kunt specificeren, des te beter kan Goteo de algemen informatie van je project evalueren.'),
...
('tooltip-project-social_reward-license', 'nl', 'Kies een licentie uit de getoonde groep. Lees ze goed voor je kiest en onthoud dat het voor <goteo belangrijk is dat de projecten de meest open licentie hebben.'),
...
('tooltip-project-social_rewards', 'nl', 'Definieer het type winst uit het project waartoe open toegang is, en de licentie die dat reguleert. Als je nog twijfelt over welke licentie het beste past, neem dan contact met ons op op, <a href="http://www.goteo.org/contact" target="new">contact us</a> en we geven je graag advies.'),
...
('tooltip-project-supports', 'nl', 'In Goteozijn er meer manieren om bij te dragen dan met geld. Sommige mnsen kunnen geen geld bijdragen maar hebben wel waardevolle vaardigheden, tijd, energie etc.'),
...
('tooltip-user-about', 'nl', 'Als sociaal netwerk probeert Goteo bij zoveel mogelijk mensen bekend te maken wat de meest interessante projecten en hun financieringsmogelijkheden zijn. Daarom is het belangrijk om informatie te delen over je vaardigheden, interesses, en ervaringen (professioneel, academisch, hobbies, etc.)'),
...
('tooltip-user-facebook', 'nl', 'Dit sociale netwerk kan je helpen bij het bekend raken met Goteo projecten die jou interesseren en je vrienden en familie.'),
...
('tooltip-user-location', 'nl', 'Dzez informatie is nodig om je te kunnen verbinden met een Goteo groep.'),
...
('tooltip-user-name', 'nl', 'Je alias op Goteo. Je kunt hem altijd veranderen. Dit is niet hetzelfde als je gebruikersnaam, die je niet meer kunt veranderen.)'),
...
('user-login-required', 'nl', 'Je moet inloggen om te kunnen interacteren met de Goteo gemeenschap'),
...
('validate-project-field-costs', 'nl', 'We raden je aan het in tenmiste 5 kostenposten op te delen, zodat we makkelijker kunnen zien of je project past bij Goteo.'),
...
('validate-project-field-currently', 'nl', 'Geef de huidige status aan van je project zodat we kunnen zien of het past bij Goteo.'),
...
('validate-project-value-keywords', 'nl', 'Noem 5 steekwoorden die helpen bij de beoordeling door Goteo.'),
...
('validate-user-field-about', 'nl', 'Vertel ons over jezelf zodat we beter kunnen beoordelen of het project geschikt is voor Goteo.'),
...
('validate-user-field-avatar', 'nl', 'Voeg een profielfoto toe zodat we beter kunnen beoordelen of het project geschikt is voor Goteo.'),
...
('validate-user-field-contribution', 'nl', 'Leg uit wat je Goteo biedt zodat we beter kunnen beoordelen of het project geschikt is voor publicatie op het platform.'),
...
('validate-user-field-facebook', 'nl', 'Voeg je Facebook gebruikersnaam toe zodat we beter kunnen beoordelen of het project geschikt is voor Goteo.'),
...
('validate-user-field-interests', 'nl', 'Selecteer een interessegebied zodat we beter kunnen beoordelen of het project geschikt is voor Goteo.'),
...
('validate-user-field-keywords', 'nl', 'Geef 5 woorden die jou definieren zodat we beter kunnen beoordelen of het project geschikt is voor Goteo.'),
...
('validate-user-field-name', 'nl', 'Voer je hele naam in zodat we beter kunnen beoordelen of het project geschikt is voor Goteo.'),
...
('validate-user-field-webs', 'nl', 'Voer het adres in van je website zodat we beter kunnen beoordelen of het project geschikt is voor Goteo.'),
