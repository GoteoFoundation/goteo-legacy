...
INSERT INTO `category_lang` VALUES(2, 'nl', 'Social', 'Projects that promote social change, resolve problems with or strengthen human relationshiops in order to achieve better well-being.');
...
INSERT INTO `category_lang` VALUES(6, 'nl', 'Communications', 'Projects whose objective is to inform, denounce and/or communicate (for example, civic journalism, documentaries, blogs, radio programs).');
...
INSERT INTO `category_lang` VALUES(7, 'nl', 'Technological', 'Technical development of software, hardware, tools, etc in order to solve concrete problems or needs.');
...
INSERT INTO `category_lang` VALUES(9, 'nl', 'Commercial', 'Projects that are business initiatives, and that hope to generate profits.');
...
INSERT INTO `category_lang` VALUES(10, 'nl', 'Educational', 'Projects whose most important objective is formation or learning. ');
...
INSERT INTO `category_lang` VALUES(11, 'nl', 'Cultural', 'Projects with artistic or cultural objectives.');
...
INSERT INTO `category_lang` VALUES(13, 'nl', 'Ecological', 'Projects that are related to the care of the environment, sustainability, and/or biological diversity.\r\n');
...
INSERT INTO `category_lang` VALUES(14, 'nl', 'Scientific', 'Studies or research, projects that look for answers, solutions, new explanations.');
...
INSERT INTO `icon_lang` VALUES('code', 'nl', 'Source code', 'By source code, we mean programs and software in general.');
...
INSERT INTO `icon_lang` VALUES('design', 'nl', 'Design', 'Designs can be drawings, patterns, sketches, rough drafts, flowcharts, etc.');
...
INSERT INTO `icon_lang` VALUES('file', 'nl', 'Digital files', 'Digital files may be music, video, text documents, etc.');
...
INSERT INTO `icon_lang` VALUES('manual', 'nl', 'Manuals', 'Practical documentation that details step-by-step instructions, tutorials, business plans, how-to''s, code cookbooks, etc. ');
...
INSERT INTO `icon_lang` VALUES('money', 'nl', 'Money', 'Economic benefits that are proportional to the investment made, with details about quantity and also form of payment');
...
INSERT INTO `icon_lang` VALUES('other', 'nl', 'Other', 'Surprise us with this category, we''re really interested!');
...
INSERT INTO `icon_lang` VALUES('product', 'nl', 'Product', 'Products can be limited editions or prototypes, or pieces or works derived from the original.');
...
INSERT INTO `icon_lang` VALUES('service', 'nl', 'Services', 'Actions or sessions during a specific period of time which satisfy an individual or group need: education, technical assistance, advice, etc. ');
...
INSERT INTO `lang` VALUES('ca', 'Català', 0, 'CAT', 'ca_ES');
...
INSERT INTO `license_lang` VALUES('agpl', 'nl', 'Affero General Public License', 'Affero General Public License for open networked software', 'http://www.affero.org/oagf.html');
...
INSERT INTO `license_lang` VALUES('apache', 'nl', 'Apache License', 'Apache License for open software, that does not require that derivative works be distributed with the same license, or even as open software', 'http://www.apache.org/licenses/LICENSE-2.0');
...
INSERT INTO `license_lang` VALUES('balloon', 'nl', 'Balloon Open Hardware License', 'License for open Balloon boards', 'http://balloonboard.org/licence.html');
...
INSERT INTO `license_lang` VALUES('bsd', 'nl', 'Berkeley Software Distribution Licenses', 'Permissive free software licenses, with few restrictions, that permit the use of source code in non-free software', 'http://en.wikipedia.org/wiki/BSD_licenses');
...
INSERT INTO `license_lang` VALUES('cc0', 'nl', 'CC0 Universal (Public Domain)', 'Creative Commons License for works dedicated to the public domain, by which all intellectual property rights over a work are waived', 'http://creativecommons.org/publicdomain/zero/1.0/deed.en');
...
INSERT INTO `license_lang` VALUES('ccby', 'nl', 'CC - Attribution', 'Creative Commons License with attribution', 'http://creativecommons.org/licenses/by/2.0/deed.en');
...
INSERT INTO `license_lang` VALUES('ccbync', 'nl', 'CC - Attribution-NonCommercial', 'Creative Commons License with attribution that does not permit commercial use', 'http://creativecommons.org/licenses/by-nc/2.0/deed.en');
...
INSERT INTO `license_lang` VALUES('ccbyncnd', 'nl', 'CC - Attribution  - NonCommercial - NoDerivs', 'Creative Commons License with attribution, that does not allow commercial use nor derivative works', 'http://creativecommons.org/licenses/by-nc-nd/2.0/deed.en');
...
INSERT INTO `license_lang` VALUES('ccbyncsa', 'nl', 'CC - Attribution - NonCommercial - ShareAlike', 'Creative Commons License with attribution, that does not allow commercial use, and only allows sharing under identical licensing conditions', 'http://creativecommons.org/licenses/by-nc-sa/3.0/deed.en');
...
INSERT INTO `license_lang` VALUES('ccbynd', 'nl', 'CC - Attribution - NoDerivs', 'Creative Commons License with attribution that does not allow derivative works', 'http://creativecommons.org/licenses/by-nd/2.0/deed.en');
...
INSERT INTO `license_lang` VALUES('ccbysa', 'nl', 'CC - Attribution - ShareAlike', 'Creative Commons License with attribution that only allows sharing under identical licensing conditions', 'http://creativecommons.org/licenses/by-sa/2.0/deed.en');
...
INSERT INTO `license_lang` VALUES('fal', 'nl', 'Free Art License', 'Free art license', 'http://artlibre.org/licence/lal/en');
...
INSERT INTO `license_lang` VALUES('fdl', 'nl', 'Free Documentation License ', 'GNU free documentation license, which can be copied, redistributed, modified and even sold, as long as the original terms of this same license are maintained.', 'http://www.gnu.org/copyleft/fdl.html');
...
INSERT INTO `license_lang` VALUES('freebsd', 'nl', 'FreeBSD Documentation License', 'Free Documentation License for the FreeBSD operating system', 'http://www.freebsd.org/copyright/freebsd-doc-license.html');
...
INSERT INTO `license_lang` VALUES('gpl', 'nl', 'General Public License', 'GNU General Public License for the free distribution, modification, and use of software', 'http://www.gnu.org/licenses/gpl.html');
...
INSERT INTO `license_lang` VALUES('gpl2', 'nl', 'General Public License (v.2)', 'GNU General Public License for the free distribution, modification, and use of software', 'http://www.gnu.org/licenses/gpl-2.0.html');
...
INSERT INTO `license_lang` VALUES('lgpl', 'nl', 'Lesser General Public License', 'GNU Lesser General Public License for free software that can be used by a non-GPL program, which in turn can be free software or not. ', 'http://www.gnu.org/copyleft/lesser.html');
...
INSERT INTO `license_lang` VALUES('mit', 'nl', 'MIT / X11 License', 'License both for open and closed software, that allows changes made to the original program to be protected', 'http://es.wikipedia.org/wiki/MIT_License');
...
INSERT INTO `license_lang` VALUES('mpl', 'nl', 'Mozilla Public License', 'Mozilla Public License for open software that makes possible the non-open reuse of software, without restricting the reuse of the code or the relicensing under the same license. ', 'http://www.mozilla.org/MPL/');
...
INSERT INTO `license_lang` VALUES('odbl', 'nl', 'Open Database License ', 'Open Database License that allows for sharing, modifying, and using databases in identical conditions', 'http://www.opendatacommons.org/licenses/odbl/');
...
INSERT INTO `license_lang` VALUES('odcby', 'nl', 'Open Data Commons Attribution License', 'Open data license that allows for sharing, modifying and using data under identical conditions, as long as attribution is given for the original source', 'http://www.opendatacommons.org/licenses/by/');
...
INSERT INTO `license_lang` VALUES('oshw', 'nl', 'Open Hardware License', 'Open Hardware License', 'http://www.tapr.org/OHL');
...
INSERT INTO `license_lang` VALUES('pd', 'nl', 'Public Domain', 'The work may be freely reproduced, distributed, transmitted, used, modified, edited, or subject to any other form of exploitation for any commerical or non-commercial use.', 'http://creativecommons.org/licenses/publicdomain/deed.en');
...
INSERT INTO `license_lang` VALUES('php', 'nl', 'PHP License', 'License under which the PHP programming language is published', 'http://www.php.net/license/');
...
INSERT INTO `license_lang` VALUES('tapr', 'nl', 'TAPR Noncommercial Hardware License', 'TAPR Noncommercial Hardware License', 'http://www.tapr.org/NCL.html');
...
INSERT INTO `license_lang` VALUES('xoln', 'nl', 'XOLN Common Good License', 'License for an open, free, neutral network, as an agreement of interconnection among equals, promoted by Guifi.net ', 'http://guifi.net/es/ProcomunXOLN');
...
INSERT INTO `text` VALUES('blog-comments_no_allowed', 'nl', 'Comments are not allowed on this post');
...
INSERT INTO `text` VALUES('blog-comments_no_comments', 'nl', 'This post has no comments');
...
INSERT INTO `text` VALUES('blog-main-header', 'nl', 'Goteo Blog');
...
INSERT INTO `text` VALUES('blog-no_comments', 'nl', 'No comment');
...
INSERT INTO `text` VALUES('blog-no_posts', 'nl', 'No posts have been published');
...
INSERT INTO `text` VALUES('blog-send_comment-button', 'nl', 'Send');
...
INSERT INTO `text` VALUES('blog-send_comment-header', 'nl', 'Write a comment');
...
INSERT INTO `text` VALUES('blog-side-last_comments', 'nl', 'Latest comments');
...
INSERT INTO `text` VALUES('blog-side-last_posts', 'nl', 'Latest posts');
...
INSERT INTO `text` VALUES('blog-side-tags', 'nl', 'Categories');
...
INSERT INTO `text` VALUES('community-menu-activity', 'nl', 'Activity');
...
INSERT INTO `text` VALUES('community-menu-main', 'nl', 'Community');
...
INSERT INTO `text` VALUES('contact-send_message-header', 'nl', 'Send us a message');
...
INSERT INTO `text` VALUES('costs-field-required_cost', 'nl', 'This expense is');
...
INSERT INTO `text` VALUES('costs-field-required_cost-no', 'nl', 'Supplemental');
...
INSERT INTO `text` VALUES('costs-field-required_cost-yes', 'nl', 'Necessary');
...
INSERT INTO `text` VALUES('costs-field-resoure', 'nl', 'Other resources');
...
INSERT INTO `text` VALUES('costs-fields-main-title', 'nl', 'Breakdown of expenses');
...
INSERT INTO `text` VALUES('costs-fields-metter-title', 'nl', 'View of expenses');
...
INSERT INTO `text` VALUES('costs-fields-resources-title', 'nl', 'Resource');
...
INSERT INTO `text` VALUES('costs-main-header', 'nl', 'Expenses');
...
INSERT INTO `text` VALUES('criteria-owner-section-header', 'nl', 'About project responsible/team');
...
INSERT INTO `text` VALUES('criteria-project-section-header', 'nl', 'About the project');
...
INSERT INTO `text` VALUES('criteria-reward-section-header', 'nl', 'About the rewards');
...
INSERT INTO `text` VALUES('dashboard-header-main', 'nl', 'My dashboard');
...
INSERT INTO `text` VALUES('dashboard-investors-mail-fail', 'nl', '    Message failed to %s: %s');
...
INSERT INTO `text` VALUES('dashboard-investors-mail-nowho', 'nl', 'No recipient was found');
...
INSERT INTO `text` VALUES('dashboard-investors-mail-sended', 'nl', 'Message sent correctly to %s: %s');
...
INSERT INTO `text` VALUES('dashboard-investors-mail-sendto', 'nl', 'Sent to %s of your backers:');
...
INSERT INTO `text` VALUES('dashboard-investors-mail-text-required', 'nl', 'Write the message');
...
INSERT INTO `text` VALUES('dashboard-menu-activity', 'nl', 'My activity');
INSERT INTO `text` VALUES('dashboard-menu-activity-spread', 'ca', 'Difusió');
INSERT INTO `text` VALUES('dashboard-menu-activity-spread', 'nl', 'Spread the word');
...
INSERT INTO `text` VALUES('dashboard-menu-activity-summary', 'nl', 'Summary');
...
INSERT INTO `text` VALUES('dashboard-menu-activity-wall', 'nl', 'My wall');
...
INSERT INTO `text` VALUES('dashboard-menu-admin_board', 'nl', 'Administration');
...
INSERT INTO `text` VALUES('dashboard-menu-main', 'nl', 'My panel');
INSERT INTO `text` VALUES('dashboard-menu-main', 'en', 'My panel');
INSERT INTO `text` VALUES('dashboard-menu-profile', 'ca', 'Perfil');
INSERT INTO `text` VALUES('dashboard-menu-profile', 'nl', 'My profile');
...
INSERT INTO `text` VALUES('dashboard-menu-profile-access', 'nl', 'Account details');
...
INSERT INTO `text` VALUES('dashboard-menu-profile-personal', 'nl', 'Personal information');
...
INSERT INTO `text` VALUES('dashboard-menu-profile-preferences', 'nl', 'Preferences');
...
INSERT INTO `text` VALUES('dashboard-menu-profile-profile', 'nl', 'Edit profile');
...
INSERT INTO `text` VALUES('dashboard-menu-profile-public', 'nl', 'Public profile');
...
INSERT INTO `text` VALUES('dashboard-menu-projects', 'nl', 'My projects');
...
INSERT INTO `text` VALUES('dashboard-menu-projects-contract', 'nl', 'Contract');
...
INSERT INTO `text` VALUES('dashboard-menu-projects-preview', 'nl', 'Public page');
...
INSERT INTO `text` VALUES('dashboard-menu-projects-rewards', 'nl', 'Manage benefits');
...
INSERT INTO `text` VALUES('dashboard-menu-projects-summary', 'nl', 'Summary');
...
INSERT INTO `text` VALUES('dashboard-menu-projects-supports', 'nl', 'Collaborations');
...
INSERT INTO `text` VALUES('dashboard-menu-projects-updates', 'nl', 'News');
...
INSERT INTO `text` VALUES('dashboard-menu-projects-widgets', 'nl', 'Widget');
...
INSERT INTO `text` VALUES('dashboard-menu-review_board', 'nl', 'Review');
...
INSERT INTO `text` VALUES('dashboard-menu-translates', 'nl', 'My translations');
...
INSERT INTO `text` VALUES('dashboard-menu-translate_board', 'nl', 'Translation');
...
INSERT INTO `text` VALUES('dashboard-password-recover-advice', 'nl', 'You are recovering your password. Remember to put your user name in the "current password" field to change it.');
...
INSERT INTO `text` VALUES('dashboard-project-blog-fail', 'nl', 'Contact us');
...
INSERT INTO `text` VALUES('dashboard-project-blog-inactive', 'nl', 'Sorry, you can''t publish news on this project right now.');
...
INSERT INTO `text` VALUES('dashboard-project-blog-wrongstatus', 'nl', 'Sorry, you can''t publish news about this project yet...');
...
INSERT INTO `text` VALUES('dashboard-project-delete_alert', 'nl', 'Are you sure you want to permanently delete this project?');
...
INSERT INTO `text` VALUES('dashboard-project-updates-deleted', 'nl', 'Post removed');
...
INSERT INTO `text` VALUES('dashboard-project-updates-delete_fail', 'nl', 'Error while removing post');
...
INSERT INTO `text` VALUES('dashboard-project-updates-fail', 'nl', 'There was a problem saving the data');
...
INSERT INTO `text` VALUES('dashboard-project-updates-inserted', 'nl', 'New post added');
...
INSERT INTO `text` VALUES('dashboard-project-updates-noblog', 'nl', 'No blog was found for this project');
...
INSERT INTO `text` VALUES('dashboard-project-updates-nopost', 'nl', 'Post not found');
...
INSERT INTO `text` VALUES('discover-banner-header', 'nl', '    By category, location or benefit,<br /><span class="red">find the project</span> that you identify with the most.');
...
INSERT INTO `text` VALUES('discover-group-all-header', 'nl', 'Campaign in progress');
...
INSERT INTO `text` VALUES('discover-group-archive-header', 'nl', 'Filed');
...
INSERT INTO `text` VALUES('discover-group-outdate-header', 'nl', 'About to expire');
...
INSERT INTO `text` VALUES('discover-group-popular-header', 'nl', 'Most popular');
...
INSERT INTO `text` VALUES('discover-group-recent-header', 'nl', 'Recent');
...
INSERT INTO `text` VALUES('discover-group-success-header', 'nl', 'Successes');
...
INSERT INTO `text` VALUES('discover-results-empty', 'nl', 'We did not find any project that matches your search criteria');
...
INSERT INTO `text` VALUES('discover-results-header', 'nl', 'Search results');
...
INSERT INTO `text` VALUES('discover-searcher-button', 'nl', 'Search');
...
INSERT INTO `text` VALUES('discover-searcher-bycategory-all', 'nl', 'ALL');
...
INSERT INTO `text` VALUES('discover-searcher-bycategory-header', 'nl', 'By category:');
...
INSERT INTO `text` VALUES('discover-searcher-bycontent-header', 'nl', 'By content:');
...
INSERT INTO `text` VALUES('discover-searcher-bylocation-all', 'nl', 'ALL');
...
INSERT INTO `text` VALUES('discover-searcher-bylocation-header', 'nl', 'By location:');
...
INSERT INTO `text` VALUES('discover-searcher-byreward-all', 'nl', 'ALL');
...
INSERT INTO `text` VALUES('discover-searcher-byreward-header', 'nl', 'By benefit:');
...
INSERT INTO `text` VALUES('discover-searcher-header', 'nl', 'Find a project');
...
INSERT INTO `text` VALUES('error-contact-email-empty', 'nl', 'You didn''t add your email address');
...
INSERT INTO `text` VALUES('error-contact-email-invalid', 'nl', 'The email you entered is not valid.');
...
INSERT INTO `text` VALUES('error-contact-message-empty', 'nl', 'You haven''t written a message');
...
INSERT INTO `text` VALUES('error-contact-subject-empty', 'nl', 'You didn''t enter a subject');
...
INSERT INTO `text` VALUES('error-image-name', 'nl', 'Error in the file name');
...
INSERT INTO `text` VALUES('error-image-size', 'nl', 'Error with the file size');
...
INSERT INTO `text` VALUES('error-image-size-too-large', 'nl', 'The image is too big.');
...
INSERT INTO `text` VALUES('error-image-tmp', 'nl', 'Error while loading the file');
...
INSERT INTO `text` VALUES('error-image-type', 'nl', 'Only JPG, PNG, and GIF images are permitted');
...
INSERT INTO `text` VALUES('error-image-type-not-allowed', 'nl', 'Only .png, .jpg, and .gif images are allowed.');
...
INSERT INTO `text` VALUES('error-register-email', 'nl', 'The email field is required.');
...
INSERT INTO `text` VALUES('error-register-email-confirm', 'nl', 'The emails don''t match.');
...
INSERT INTO `text` VALUES('error-register-email-exists', 'nl', 'The email you entered is registered to an existing user.');
...
INSERT INTO `text` VALUES('error-register-invalid-password', 'nl', 'That password is not valid.');
...
INSERT INTO `text` VALUES('error-register-password-confirm', 'nl', 'The passwords don''t match.');
...
INSERT INTO `text` VALUES('error-register-pasword', 'nl', 'You can''t leave the password field empty.');
...
INSERT INTO `text` VALUES('error-register-pasword-empty', 'nl', 'You didn''t enter a password');
...
INSERT INTO `text` VALUES('error-register-short-password', 'nl', 'The password should have at least 8 characters.');
...
INSERT INTO `text` VALUES('error-register-user-exists', 'nl', 'That user name is already registered.');
...
INSERT INTO `text` VALUES('error-register-userid', 'nl', 'You have to enter a user name');
...
INSERT INTO `text` VALUES('error-register-username', 'nl', 'You have to enter a screen name.');
...
INSERT INTO `text` VALUES('error-user-email-confirm', 'nl', 'The email confirmation is not the same as the email.');
...
INSERT INTO `text` VALUES('error-user-email-empty', 'nl', 'You can''t leave the email field empty');
...
INSERT INTO `text` VALUES('error-user-email-exists', 'nl', 'There is already a registered user with that email address');
...
INSERT INTO `text` VALUES('error-user-email-invalid', 'nl', 'The email you entered is not valid.');
...
INSERT INTO `text` VALUES('error-user-email-token-invalid', 'nl', 'The code is incorrect');
...
INSERT INTO `text` VALUES('error-user-password-confirm', 'nl', 'The password confirmation is not the same as the password.');
...
INSERT INTO `text` VALUES('error-user-password-empty', 'nl', 'You didn''t enter a password');
...
INSERT INTO `text` VALUES('error-user-password-invalid', 'nl', 'The password is too short. It has to have at least 6 characters.');
...
INSERT INTO `text` VALUES('error-user-wrong-password', 'nl', 'The password is incorrect.');
...
INSERT INTO `text` VALUES('faq-ask-question', 'nl', 'Didn''t this solve your question? Send us a message.');
...
INSERT INTO `text` VALUES('faq-investors-section-header', 'nl', 'For co-financiers');
...
INSERT INTO `text` VALUES('faq-main-section-header', 'nl', 'An approach to Goteo');
...
INSERT INTO `text` VALUES('faq-nodes-section-header', 'nl', 'About local nodes');
...
INSERT INTO `text` VALUES('faq-project-section-header', 'nl', 'About the projects');
...
INSERT INTO `text` VALUES('faq-sponsor-section-header', 'nl', 'For promoters');
...
INSERT INTO `text` VALUES('fatal-error-project', 'nl', 'The project you''re looking for... <span class="red">does not exist :(</span>');
...
INSERT INTO `text` VALUES('fatal-error-user', 'nl', 'The user you''re looking for... <span class="red">does not exist :(</span>');
...
INSERT INTO `text` VALUES('feed-blog-comment', 'nl', 'Has written a <span class="green">Comment</span> at the post "%s" from the %s blog');
...
INSERT INTO `text` VALUES('feed-messages-new_thread', 'nl', 'Has opened a thread at %s of the project %s');
...
INSERT INTO `text` VALUES('feed-messages-response', 'nl', 'Has answered to %s of the project %s');
...
INSERT INTO `text` VALUES('feed-new_project', 'nl', '    <span class="red">New Goteo project</span>, you''ve got 40 days from today to support this project.');
...
INSERT INTO `text` VALUES('feed-new_support', 'nl', 'Has published a new <span class="green">Collaboration</span> at the %s project, with the title "%s"');
...
INSERT INTO `text` VALUES('feed-new_user', 'nl', 'New Goteo user, %s');
...
INSERT INTO `text` VALUES('feed-project_fail', 'nl', '    The project, %s, has <span class="red">closed</span> having only received <span class="violet">%s ? (%s %) of the minimum contribution</span>');
...
INSERT INTO `text` VALUES('feed-project_finish', 'nl', '    The project, %s, has <span class="red">completed the second round</span> having received <span class="violet">%s ? (%s %) of the minimum contribution</span>');
...
INSERT INTO `text` VALUES('feed-project_goon', 'nl', '    The project, %s, <span class="red">will continue</span> in the second round since it received <span class="violet">%s ? (%s %) of the minimum required contributions</span>');
...
INSERT INTO `text` VALUES('feed-project_runout', 'nl', 'The %s project has <span class="red">%s more days</span> until the end of round number %s');
...
INSERT INTO `text` VALUES('feed-timeago-periods', 'nl', 'second-seconds_minute-minutes_hour-hours_day-days_week-weeks_month-months_year-years_decade-decades');
...
INSERT INTO `text` VALUES('feed-timeago-published', 'nl', 'Published %s ago');
...
INSERT INTO `text` VALUES('feed-updates-comment', 'nl', 'Has written a <span class="green">Comment</span> to the message "%s" on %s of the %s project');
...
INSERT INTO `text` VALUES('footer-header-categories', 'nl', 'Categories');
...
INSERT INTO `text` VALUES('footer-header-projects', 'nl', 'Projects');
...
INSERT INTO `text` VALUES('footer-header-resources', 'nl', 'Resources');
...
INSERT INTO `text` VALUES('footer-header-services', 'nl', 'Services');
...
INSERT INTO `text` VALUES('footer-header-social', 'nl', 'Follow us');
...
INSERT INTO `text` VALUES('footer-header-sponsors', 'nl', 'Institutional support');
...
INSERT INTO `text` VALUES('footer-platoniq-iniciative', 'nl', 'An initiative of:');
...
INSERT INTO `text` VALUES('footer-resources-glossary', 'nl', 'Glossary');
...
INSERT INTO `text` VALUES('footer-resources-press', 'nl', 'Press Kit');
...
INSERT INTO `text` VALUES('footer-service-campaign', 'nl', 'Campaigns');
...
INSERT INTO `text` VALUES('footer-service-consulting', 'nl', 'Consulting firm');
...
INSERT INTO `text` VALUES('footer-service-resources', 'nl', 'Feeder capital');
...
INSERT INTO `text` VALUES('form-ajax-info', 'nl', 'This form is saved automatically while you fill it out');
...
INSERT INTO `text` VALUES('form-errors-total', 'nl', 'There''s %s errors in total');
...
INSERT INTO `text` VALUES('form-footer-errors_title', 'nl', 'Errors');
...
INSERT INTO `text` VALUES('form-image_upload-button', 'nl', 'Upload image');
...
INSERT INTO `text` VALUES('form-project-info_status-title', 'nl', 'Overall status of information');
...
INSERT INTO `text` VALUES('form-project-progress-title', 'nl', 'Data evaluation');
...
INSERT INTO `text` VALUES('form-project-status-title', 'nl', 'Project status');
...
INSERT INTO `text` VALUES('form-project_status-campaing', 'nl', 'Campaign in progress');
...
INSERT INTO `text` VALUES('form-project_status-cancel', 'nl', 'Discarded');
...
INSERT INTO `text` VALUES('form-project_status-cancelled', 'nl', 'Canceled');
...
INSERT INTO `text` VALUES('form-project_status-edit', 'nl', 'In review');
...
INSERT INTO `text` VALUES('form-project_status-expired', 'nl', 'Closed');
...
INSERT INTO `text` VALUES('form-project_status-fulfilled', 'nl', 'Benefit completed');
...
INSERT INTO `text` VALUES('form-project_status-review', 'nl', 'Evaluation pending');
...
INSERT INTO `text` VALUES('form-project_status-success', 'nl', 'Funded');
...
INSERT INTO `text` VALUES('form-project_waitfor-campaing', 'nl', 'Spread the word about your project. Help get the most support!');
...
INSERT INTO `text` VALUES('form-project_waitfor-cancel', 'nl', 'We have decided not to publish your proposal on Goteo, though we invite you to try again with a different idea or concept.');
...
INSERT INTO `text` VALUES('form-project_waitfor-edit', 'nl', 'When it''s ready, send it for review. You have to provide a minimum of information about your project on the form.');
...
INSERT INTO `text` VALUES('form-project_waitfor-expired', 'nl', 'It didn''t work out. Make it better and try again!');
...
INSERT INTO `text` VALUES('form-project_waitfor-fulfilled', 'nl', 'You''ve managed all the benefits. Thanks for participating!');
...
INSERT INTO `text` VALUES('form-project_waitfor-review', 'nl', 'We will get back to you as soon as we''ve had a chance to review your project. At that point, we will either post your project, or suggest ways to make it fit better on Goteo.');
...
INSERT INTO `text` VALUES('form-project_waitfor-success', 'nl', 'You have reached or surpassed your co-financing goal for this project. We will contact you shortly to talk about money :)');
...
INSERT INTO `text` VALUES('guide-dashboard-user-access', 'nl', 'You can change the information with which you log in to your Goteo account.');
...
INSERT INTO `text` VALUES('guide-dashboard-user-personal', 'nl', 'You should only fill in this data if you have created a project and you want it to be co-financed and supported through Goteo. The information in this section is necessary so that we can contact you in the event that you obtain the necessary co-financing, and make the corresponding deposit.');
...
INSERT INTO `text` VALUES('guide-dashboard-user-preferences', 'nl', 'Select ''Yes'' for the automatic notifications you want to block.');
...
INSERT INTO `text` VALUES('guide-dashboard-user-profile', 'nl', 'Whether you want to create a project or co-finance someone else''s, in order to join the Goteo community, we recommend that you carefully edit your presentation text, and include relevant links about what you do as well as a profile image with which you identify');
...
INSERT INTO `text` VALUES('guide-project-comment', 'nl', 'guide-project-comment');
...
INSERT INTO `text` VALUES('guide-project-error-mandatories', 'nl', 'Some required fields are missing');
...
INSERT INTO `text` VALUES('guide-project-success-minprogress', 'nl', 'You have achieved the minimum percentage');
...
INSERT INTO `text` VALUES('guide-project-success-noerrors', 'nl', 'All of the required fields are filled out');
...
INSERT INTO `text` VALUES('guide-project-success-okfinish', 'nl', 'You can send it for reviewing');
INSERT INTO `text` VALUES('guide-project-success-okfinish', 'en', 'You can send it for reviewing');
INSERT INTO `text` VALUES('guide-project-support', 'nl', 'guide-project-support');
...
INSERT INTO `text` VALUES('home-promotes-header', 'nl', 'Highlighted');
...
INSERT INTO `text` VALUES('image-upload-fail', 'nl', 'Error uploading image');
...
INSERT INTO `text` VALUES('invest-address-address-field', 'nl', 'Address:');
...
INSERT INTO `text` VALUES('invest-address-country-field', 'nl', 'Country:');
...
INSERT INTO `text` VALUES('invest-address-header', 'nl', 'Where would you like to receive the reward (only if it''s sent via the postal service)');
...
INSERT INTO `text` VALUES('invest-address-location-field', 'nl', 'City');
INSERT INTO `text` VALUES('invest-address-location-field', 'en', 'City');
INSERT INTO `text` VALUES('invest-address-name-field', 'ca', 'Nom:');
INSERT INTO `text` VALUES('invest-address-name-field', 'nl', 'Name:');
...
INSERT INTO `text` VALUES('invest-address-nif-field', 'nl', 'VAT:');
...
INSERT INTO `text` VALUES('invest-amount-tooltip', 'nl', 'Enter the quantity with which you want to support this project');
...
INSERT INTO `text` VALUES('invest-anonymous', 'nl', 'Please make my donation anonymous');
...
INSERT INTO `text` VALUES('invest-create-error', 'nl', 'There has been a problem when processing the payment');
...
INSERT INTO `text` VALUES('invest-data-error', 'nl', 'Necessary data missing');
...
INSERT INTO `text` VALUES('invest-donation-header', 'nl', 'Enter the fiscal information for this donation');
...
INSERT INTO `text` VALUES('invest-individual-header', 'nl', 'You can decline to receive rewards for your contribution, or select those that match or are under the amount that you have entered.');
...
INSERT INTO `text` VALUES('invest-next_step', 'nl', 'Next step');
...
INSERT INTO `text` VALUES('invest-payment-email', 'nl', 'Enter your PayPal user name');
...
INSERT INTO `text` VALUES('invest-payment_method-header', 'nl', 'Choose a method of payment');
...
INSERT INTO `text` VALUES('invest-paypal-error_fatal', 'nl', 'There has been a fatal error when connecting to PayPal. The incidence has been notified, sorry for the inconvenience.');
...
INSERT INTO `text` VALUES('invest-resign', 'nl', 'I don''t want any reward, I just want to help the project');
...
INSERT INTO `text` VALUES('invest-reward-none', 'nl', 'These can no longer be chosen');
...
INSERT INTO `text` VALUES('invest-social-header', 'nl', 'With collective benefits, we all move forward');
...
INSERT INTO `text` VALUES('invest-tpv-error_fatal', 'nl', 'There has been a fatal error when checking out. The incidence has been notified, sorry for the inconvenience.');
...
INSERT INTO `text` VALUES('leave-email-sended', 'nl', 'We have sent you an email to confirm the closure of your account. If you don''t find it right away, look in your junk or spam folder.');
...
INSERT INTO `text` VALUES('leave-process-completed', 'nl', 'The account was closed correctly.');
...
INSERT INTO `text` VALUES('leave-process-fail', 'nl', 'We were not able to close the account. Please contact us at hola@goteo.org');
...
INSERT INTO `text` VALUES('leave-request-fail', 'nl', 'We didn''t find any account with that email in our database.');
...
INSERT INTO `text` VALUES('leave-token-incorrect', 'nl', 'The code for completing the closure of the account is not valid.');
...
INSERT INTO `text` VALUES('login-access-password-field', 'nl', 'Password');
...
INSERT INTO `text` VALUES('login-access-username-field', 'nl', 'User name');
...
INSERT INTO `text` VALUES('login-banner-header', 'nl', '    Get access to the <br /><span class="greenblue">100% open</span> Goteo community');
...
INSERT INTO `text` VALUES('login-fail', 'nl', 'Error');
INSERT INTO `text` VALUES('login-fail', 'en', 'Error');
INSERT INTO `text` VALUES('login-leave-button', 'ca', 'Donar de baixa');
INSERT INTO `text` VALUES('login-leave-button', 'nl', 'Close the account');
...
INSERT INTO `text` VALUES('login-leave-header', 'nl', 'Close the account');
...
INSERT INTO `text` VALUES('login-leave-message', 'nl', 'Leave a message');
...
INSERT INTO `text` VALUES('login-oneclick-header', 'nl', 'Log in with a single click');
...
INSERT INTO `text` VALUES('login-recover-button', 'nl', 'Recover');
...
INSERT INTO `text` VALUES('login-recover-email-field', 'nl', 'Account email');
...
INSERT INTO `text` VALUES('login-recover-header', 'nl', 'Recover password');
...
INSERT INTO `text` VALUES('login-recover-link', 'nl', 'Recover password');
...
INSERT INTO `text` VALUES('login-recover-username-field', 'nl', 'User name');
...
INSERT INTO `text` VALUES('login-register-button', 'nl', 'Register');
...
INSERT INTO `text` VALUES('login-register-confirm-field', 'nl', 'Confirm email address');
...
INSERT INTO `text` VALUES('login-register-confirm_password-field', 'nl', 'Confirm password');
...
INSERT INTO `text` VALUES('login-register-email-field', 'nl', 'Email address');
...
INSERT INTO `text` VALUES('login-register-header', 'nl', 'New user');
...
INSERT INTO `text` VALUES('login-register-password-field', 'nl', 'Password');
...
INSERT INTO `text` VALUES('login-register-password-minlength', 'nl', 'At least 6 characters');
...
INSERT INTO `text` VALUES('login-register-userid-field', 'nl', 'User name');
...
INSERT INTO `text` VALUES('login-register-username-field', 'nl', 'Screen name');
...
INSERT INTO `text` VALUES('login-signin-facebook', 'nl', 'Log in with Facebook');
...
INSERT INTO `text` VALUES('login-signin-google', 'nl', 'Log in with Google');
...
INSERT INTO `text` VALUES('login-signin-linkedin', 'nl', 'Log in with LinkedIn');
...
INSERT INTO `text` VALUES('login-signin-myopenid', 'nl', 'Log in with myOpenID');
...
INSERT INTO `text` VALUES('login-signin-view-more', 'nl', 'More login options');
...
INSERT INTO `text` VALUES('login-signin-yahoo', 'nl', 'Log in with Yahoo');
...
INSERT INTO `text` VALUES('mailer-baja', 'nl', 'If you don''t want to receive more updates form Goteo.org, you can unsubscribe your email address with <a href="%s">link</a>');
...
INSERT INTO `text` VALUES('mailer-disclaimer', 'nl', 'Goteo this is a translation test');
...
INSERT INTO `text` VALUES('mailer-sinoves', 'nl', 'If you can''t see this message use this <a href="%s">link</a>');
...
INSERT INTO `text` VALUES('main-banner-header', 'nl', '    <h2 class="message">Social network for <span class="greenblue">co-financing and collaborating with </span><br /> creative projects that further the common good<br /> Do you have a project with <span class="greenblue">open DNA</span>?</h2><a href="/contact" class="button banner-button">Contact us!</a>');
...
INSERT INTO `text` VALUES('mandatory-cost-field-amount', 'nl', 'You must assign an amount to the expenses');
...
INSERT INTO `text` VALUES('mandatory-cost-field-description', 'nl', 'You must add a description for the expenses');
...
INSERT INTO `text` VALUES('mandatory-cost-field-name', 'nl', 'You must label the expenses');
...
INSERT INTO `text` VALUES('mandatory-cost-field-task_dates', 'nl', 'You must specify the approximate dates for the task');
...
INSERT INTO `text` VALUES('mandatory-cost-field-type', 'nl', 'You have to select the type of cost');
...
INSERT INTO `text` VALUES('mandatory-individual_reward-field-amount', 'nl', 'You have to specify the amount that qualifies for the reward');
...
INSERT INTO `text` VALUES('mandatory-individual_reward-field-description', 'nl', 'You must add a description');
...
INSERT INTO `text` VALUES('mandatory-individual_reward-field-icon', 'nl', 'You must choose the type of reward');
...
INSERT INTO `text` VALUES('mandatory-individual_reward-field-name', 'nl', 'You must enter a reward');
...
INSERT INTO `text` VALUES('mandatory-project-costs', 'nl', 'These should be broken down into at least two groups.');
...
INSERT INTO `text` VALUES('mandatory-project-field-about', 'nl', 'You have to explain the project''s basic characteristics');
...
INSERT INTO `text` VALUES('mandatory-project-field-address', 'nl', 'The project leaders'' address is required');
...
INSERT INTO `text` VALUES('mandatory-project-field-category', 'nl', 'You must choose at least one category for the project');
...
INSERT INTO `text` VALUES('mandatory-project-field-contract_birthdate', 'nl', 'You must enter the project leader''s date of birth');
...
INSERT INTO `text` VALUES('mandatory-project-field-contract_email', 'nl', 'You must enter the project leader''s email');
...
INSERT INTO `text` VALUES('mandatory-project-field-contract_name', 'nl', 'You must enter the name of the project leader');
...
INSERT INTO `text` VALUES('mandatory-project-field-contract_nif', 'nl', 'You must enter the ID number for the project leader');
...
INSERT INTO `text` VALUES('mandatory-project-field-country', 'nl', 'You must enter a country for the project leader');
...
INSERT INTO `text` VALUES('mandatory-project-field-description', 'nl', 'You have to enter a summary for the project');
...
INSERT INTO `text` VALUES('mandatory-project-field-entity_cif', 'nl', 'You must enter the organization''s Business Number (CIF)');
...
INSERT INTO `text` VALUES('mandatory-project-field-entity_name', 'nl', 'You must enter the name of the organization');
...
INSERT INTO `text` VALUES('mandatory-project-field-entity_office', 'nl', 'You must enter the position that you have in the organization that you represent');
...
INSERT INTO `text` VALUES('mandatory-project-field-goal', 'nl', 'You have to explain your goals in the project description');
...
INSERT INTO `text` VALUES('mandatory-project-field-image', 'nl', 'You have to link at least one image to your project');
...
INSERT INTO `text` VALUES('mandatory-project-field-lang', 'nl', 'You have to indicate a language for the project');
...
INSERT INTO `text` VALUES('mandatory-project-field-location', 'nl', 'You have to enter the potential reach for your project');
...
INSERT INTO `text` VALUES('mandatory-project-field-media', 'nl', 'We recommend uploading a video to facilitate the evaluation of your project by the Goteo team.');
...
INSERT INTO `text` VALUES('mandatory-project-field-motivation', 'nl', 'You have to explain your motivation in the project description');
...
INSERT INTO `text` VALUES('mandatory-project-field-name', 'nl', 'You have to enter a name for the project');
...
INSERT INTO `text` VALUES('mandatory-project-field-phone', 'nl', 'You must enter a phone number for the project leader');
...
INSERT INTO `text` VALUES('mandatory-project-field-related', 'nl', 'In the project description, you must describe your project-related experience and the team that you''re planning on working with.');
...
INSERT INTO `text` VALUES('mandatory-project-field-residence', 'nl', 'You must enter the project leader''s place of residence');
...
INSERT INTO `text` VALUES('mandatory-project-field-resource', 'nl', 'You must specify whether or not you have other resources to draw from');
...
INSERT INTO `text` VALUES('mandatory-project-field-zipcode', 'nl', 'A postal code for the project leader is required');
...
INSERT INTO `text` VALUES('mandatory-project-resource', 'nl', 'You must specify whether or not you have other resources to draw from');
...
INSERT INTO `text` VALUES('mandatory-project-total-costs', 'nl', 'You must specify an expense');
...
INSERT INTO `text` VALUES('mandatory-register-field-email', 'nl', 'You have to enter an email address');
...
INSERT INTO `text` VALUES('mandatory-social_reward-field-description', 'nl', 'You must enter a description for the benefit');
...
INSERT INTO `text` VALUES('mandatory-social_reward-field-icon', 'nl', 'You must choose the type of benefit');
...
INSERT INTO `text` VALUES('mandatory-social_reward-field-name', 'nl', 'You must specify the benefit');
...
INSERT INTO `text` VALUES('mandatory-support-field-description', 'nl', 'A description is required.');
...
INSERT INTO `text` VALUES('mandatory-support-field-name', 'nl', 'You have to enter a name for the collaboration');
...
INSERT INTO `text` VALUES('oauth-confirm-user', 'nl', 'Connect with existing user');
...
INSERT INTO `text` VALUES('oauth-facebook-access-denied', 'nl', 'Facebook access denied');
...
INSERT INTO `text` VALUES('oauth-goteo-openid-sync-password', 'nl', 'You''re trying to connect an existing Goteo account with an external provider. That will allow you to access Goteo with a single click.<br>This time you must provide your Goteo account password in order to confirm your identity.');
...
INSERT INTO `text` VALUES('oauth-goteo-user-not-exists', 'nl', 'That user does not exist in Goteo');
...
INSERT INTO `text` VALUES('oauth-goteo-user-password-exists', 'nl', 'That user already exists in Goteo');
...
INSERT INTO `text` VALUES('oauth-import-about', 'nl', 'About you');
...
INSERT INTO `text` VALUES('oauth-import-facebook', 'nl', 'Link to your Facebook account');
...
INSERT INTO `text` VALUES('oauth-import-location', 'nl', 'Place of residence');
INSERT INTO `text` VALUES('oauth-import-location', 'en', 'Place of residence');
INSERT INTO `text` VALUES('oauth-import-name', 'ca', 'Nom');
INSERT INTO `text` VALUES('oauth-import-name', 'nl', 'Name');
...
INSERT INTO `text` VALUES('oauth-import-twitter', 'nl', 'Link to your Twitter account');
...
INSERT INTO `text` VALUES('oauth-import-website', 'nl', 'Your websites');
...
INSERT INTO `text` VALUES('oauth-linkedin-access-denied', 'nl', 'Linkedin access denied');
...
INSERT INTO `text` VALUES('oauth-login-imported-data', 'nl', 'This data is also being imported, you can change it once authenticated:');
...
INSERT INTO `text` VALUES('oauth-login-welcome-from', 'nl', 'Welcome to Goteo. Please check your username and email to finish the process. In case we could not import the email address (or if you change it for another) an email will be sent with an activation link for validation.');
...
INSERT INTO `text` VALUES('oauth-openid-access-denied', 'nl', 'Open ID access denied');
...
INSERT INTO `text` VALUES('oauth-openid-not-logged', 'nl', 'User disconnected from Open ID');
...
INSERT INTO `text` VALUES('oauth-token-request-error', 'nl', 'There has been an error when getting data from provider');
...
INSERT INTO `text` VALUES('oauth-twitter-access-denied', 'nl', 'Twitter access denied');
...
INSERT INTO `text` VALUES('oauth-unknown-provider', 'nl', 'Session can''t be started with this provider');
...
INSERT INTO `text` VALUES('open-banner-header', 'nl', '<div class="modpo-open">OPEN</div><div class="modpo-percent">100&#37; OPEN</div><div class="modpo-whyopen">%s</div>');
...
INSERT INTO `text` VALUES('overview-field-about', 'nl', 'About');
INSERT INTO `text` VALUES('overview-field-about', 'en', 'About');
INSERT INTO `text` VALUES('overview-field-categories', 'ca', 'Categories');
INSERT INTO `text` VALUES('overview-field-categories', 'nl', 'Categories');
...
INSERT INTO `text` VALUES('overview-field-currently', 'nl', 'Current status');
...
INSERT INTO `text` VALUES('overview-field-description', 'nl', 'Brief description');
...
INSERT INTO `text` VALUES('overview-field-goal', 'nl', 'Goals of the Crowdfunding Campaign');
...
INSERT INTO `text` VALUES('overview-field-image_gallery', 'nl', 'Current images');
...
INSERT INTO `text` VALUES('overview-field-image_upload', 'nl', 'Upload an image');
...
INSERT INTO `text` VALUES('overview-field-lang', 'nl', 'Original language');
...
INSERT INTO `text` VALUES('overview-field-media', 'nl', 'Video introduction');
...
INSERT INTO `text` VALUES('overview-field-media_preview', 'nl', 'Preview');
...
INSERT INTO `text` VALUES('overview-field-motivation', 'nl', 'Why this is important for you');
...
INSERT INTO `text` VALUES('overview-field-name', 'nl', 'Project title');
...
INSERT INTO `text` VALUES('overview-field-options-currently_avanzado', 'nl', 'Advanced');
...
INSERT INTO `text` VALUES('overview-field-options-currently_finalizado', 'nl', 'Finished');
...
INSERT INTO `text` VALUES('overview-field-options-currently_inicial', 'nl', 'Starting');
...
INSERT INTO `text` VALUES('overview-field-options-currently_medio', 'nl', 'Midway');
...
INSERT INTO `text` VALUES('overview-field-options-scope_global', 'nl', 'Global');
...
INSERT INTO `text` VALUES('overview-field-options-scope_local', 'nl', 'Local');
...
INSERT INTO `text` VALUES('overview-field-options-scope_nacional', 'nl', 'National');
...
INSERT INTO `text` VALUES('overview-field-options-scope_regional', 'nl', 'Regional');
...
INSERT INTO `text` VALUES('overview-field-project_location', 'nl', 'Location');
...
INSERT INTO `text` VALUES('overview-field-related', 'nl', 'Team and Experience');
...
INSERT INTO `text` VALUES('overview-field-scope', 'nl', 'Project reach');
...
INSERT INTO `text` VALUES('overview-field-subtitle', 'nl', 'Summary');
...
INSERT INTO `text` VALUES('overview-field-usubs', 'nl', 'Publish with Universal Subtitles');
...
INSERT INTO `text` VALUES('overview-field-video', 'nl', 'Additional video about motivation');
...
INSERT INTO `text` VALUES('overview-fields-images-title', 'nl', 'Images from the project');
...
INSERT INTO `text` VALUES('overview-main-header', 'nl', 'Project description');
...
INSERT INTO `text` VALUES('personal-field-address', 'nl', 'Address');
...
INSERT INTO `text` VALUES('personal-field-contract_birthdate', 'nl', 'Date of birth');
...
INSERT INTO `text` VALUES('personal-field-contract_data', 'nl', 'Information about the project leader');
...
INSERT INTO `text` VALUES('personal-field-contract_email', 'nl', 'Email linked to the project');
...
INSERT INTO `text` VALUES('personal-field-contract_entity', 'nl', 'Project promoter');
...
INSERT INTO `text` VALUES('personal-field-contract_entity-entity', 'nl', 'Legal entity (associations, foundations, businesses, etc.)');
...
INSERT INTO `text` VALUES('personal-field-contract_entity-person', 'nl', 'Person');
...
INSERT INTO `text` VALUES('personal-field-contract_name', 'nl', 'First and last names');
...
INSERT INTO `text` VALUES('personal-field-contract_nif', 'nl', 'NIF / NIE / VAT number');
...
INSERT INTO `text` VALUES('personal-field-country', 'nl', 'Country');
...
INSERT INTO `text` VALUES('personal-field-entity_cif', 'nl', 'Organization''s Business ID Number (CIF)');
...
INSERT INTO `text` VALUES('personal-field-entity_name', 'nl', 'Official name of the organization');
...
INSERT INTO `text` VALUES('personal-field-entity_office', 'nl', 'Position in the organization');
...
INSERT INTO `text` VALUES('personal-field-location', 'nl', 'City');
...
INSERT INTO `text` VALUES('personal-field-main_address', 'nl', 'Legal address');
...
INSERT INTO `text` VALUES('personal-field-phone', 'nl', 'Telephone');
...
INSERT INTO `text` VALUES('personal-field-post_address', 'nl', 'Postal address');
...
INSERT INTO `text` VALUES('personal-field-post_address-different', 'nl', 'Different');
...
INSERT INTO `text` VALUES('personal-field-post_address-same', 'nl', 'Same');
...
INSERT INTO `text` VALUES('personal-field-zipcode', 'nl', 'Postal code');
...
INSERT INTO `text` VALUES('personal-main-header', 'nl', 'Information about the project leader');
...
INSERT INTO `text` VALUES('preview-main-header', 'nl', 'Information preview');
...
INSERT INTO `text` VALUES('preview-send-comment', 'nl', 'Additional notes for the administrator');
...
INSERT INTO `text` VALUES('profile-about-header', 'nl', 'About me');
...
INSERT INTO `text` VALUES('profile-field-about', 'nl', 'Tell us something about yourself');
...
INSERT INTO `text` VALUES('profile-field-avatar_current', 'nl', 'Your current image');
...
INSERT INTO `text` VALUES('profile-field-avatar_upload', 'nl', 'Upload an image');
...
INSERT INTO `text` VALUES('profile-field-contribution', 'nl', 'What can you offer Goteo?');
...
INSERT INTO `text` VALUES('profile-field-interests', 'nl', 'What kind of project motivates you most?');
...
INSERT INTO `text` VALUES('profile-field-keywords', 'nl', 'Topics that interest you');
...
INSERT INTO `text` VALUES('profile-field-location', 'nl', 'Place of residence');
...
INSERT INTO `text` VALUES('profile-fields-image-title', 'nl', 'Profile image');
...
INSERT INTO `text` VALUES('profile-fields-social-title', 'nl', 'Social profiles');
...
INSERT INTO `text` VALUES('profile-interests-header', 'nl', 'I am interested in projects that are...');
...
INSERT INTO `text` VALUES('profile-invest_on-header', 'nl', 'Projects that I support');
...
INSERT INTO `text` VALUES('profile-invest_on-title', 'nl', 'Co-finances');
...
INSERT INTO `text` VALUES('profile-keywords-header', 'nl', 'My key words');
INSERT INTO `text` VALUES('profile-keywords-header', 'en', 'My key words');
INSERT INTO `text` VALUES('profile-last_worth-title', 'ca', 'Data');
INSERT INTO `text` VALUES('profile-last_worth-title', 'nl', 'Date');
...
INSERT INTO `text` VALUES('profile-main-header', 'nl', 'Profile data');
...
INSERT INTO `text` VALUES('profile-my_investors-header', 'nl', 'My co-financiers');
...
INSERT INTO `text` VALUES('profile-my_projects-header', 'nl', 'My projects');
...
INSERT INTO `text` VALUES('profile-my_worth-header', 'nl', 'My flow on Goteo');
...
INSERT INTO `text` VALUES('profile-name-header', 'nl', 'Profile of');
...
INSERT INTO `text` VALUES('profile-sharing_interests-header', 'nl', 'Sharing interests');
...
INSERT INTO `text` VALUES('profile-widget-user-header', 'nl', 'User');
INSERT INTO `text` VALUES('profile-widget-user-header', 'en', 'User');
INSERT INTO `text` VALUES('profile-worth-title', 'ca', 'Aporta aquí:');
INSERT INTO `text` VALUES('profile-worth-title', 'nl', 'Contribute here:');
...
INSERT INTO `text` VALUES('profile-worthcracy-title', 'nl', 'Position');
...
INSERT INTO `text` VALUES('project-collaborations-supertitle', 'nl', 'Non-economic needs');
...
INSERT INTO `text` VALUES('project-collaborations-title', 'nl', 'Looking for');
...
INSERT INTO `text` VALUES('project-form-header', 'nl', 'Form');
...
INSERT INTO `text` VALUES('project-invest-closed', 'nl', 'The project page has expired');
...
INSERT INTO `text` VALUES('project-invest-continue', 'nl', 'Choose a method of payment');
...
INSERT INTO `text` VALUES('project-invest-fail', 'nl', 'Something went wrong, please try again.');
...
INSERT INTO `text` VALUES('project-invest-guest', 'nl', 'Guest (Don''t forget to register)');
...
INSERT INTO `text` VALUES('project-invest-ok', 'nl', 'Your contribution to co-finance this project has been processed :)');
...
INSERT INTO `text` VALUES('project-invest-start', 'nl', 'You''re one step away from becoming a co-financer of this project');
...
INSERT INTO `text` VALUES('project-invest-thanks_mail-fail', 'nl', 'There has been an error when sending the gratitude message');
...
INSERT INTO `text` VALUES('project-invest-thanks_mail-success', 'nl', 'Gratitude message correctly sent');
...
INSERT INTO `text` VALUES('project-messages-send_direct-header', 'nl', 'Send a message to this project''s promoter');
...
INSERT INTO `text` VALUES('project-messages-send_message-button', 'nl', 'Send');
...
INSERT INTO `text` VALUES('project-messages-send_message-header', 'nl', 'Write your message');
...
INSERT INTO `text` VALUES('project-messages-send_message-your_answer', 'nl', 'Write your answer here');
...
INSERT INTO `text` VALUES('project-review-confirm_mail-fail', 'nl', 'There has been an error when sending the confirmation message');
...
INSERT INTO `text` VALUES('project-review-confirm_mail-success', 'nl', 'Reviewing confirmation message correctly sent');
...
INSERT INTO `text` VALUES('project-review-request_mail-fail', 'nl', 'There has been an error when sending the reviewing invitation');
...
INSERT INTO `text` VALUES('project-review-request_mail-success', 'nl', 'Reviewing invitation message correctly sent');
...
INSERT INTO `text` VALUES('project-rewards-header', 'nl', 'Benefits');
...
INSERT INTO `text` VALUES('project-rewards-individual_reward-limited', 'nl', 'Limited reward');
...
INSERT INTO `text` VALUES('project-rewards-individual_reward-title', 'nl', 'Individual rewards');
...
INSERT INTO `text` VALUES('project-rewards-individual_reward-units_left', 'nl', ' <span class="left">%s</span> units left');
...
INSERT INTO `text` VALUES('project-rewards-social_reward-title', 'nl', 'Collective benefits');
...
INSERT INTO `text` VALUES('project-rewards-supertitle', 'nl', 'What is offered in exchange');
...
INSERT INTO `text` VALUES('project-share-header', 'nl', 'Share this project');
...
INSERT INTO `text` VALUES('project-share-pre_header', 'nl', 'Let your network know that');
...
INSERT INTO `text` VALUES('project-side-investors-header', 'nl', 'Already contributed');
...
INSERT INTO `text` VALUES('project-spread-embed_code', 'nl', 'Embedding Code');
...
INSERT INTO `text` VALUES('project-spread-header', 'nl', 'Spread the word');
...
INSERT INTO `text` VALUES('project-spread-pre_widget', 'nl', 'Spread the word');
...
INSERT INTO `text` VALUES('project-spread-widget', 'nl', 'Project widget');
...
INSERT INTO `text` VALUES('project-spread-widget_legend', 'nl', 'Copy and paste the code in your website or blog to help spread the word about this project');
...
INSERT INTO `text` VALUES('project-spread-widget_title', 'nl', 'publish the project widget');
...
INSERT INTO `text` VALUES('project-support-supertitle', 'nl', 'Economic needs');
...
INSERT INTO `text` VALUES('project-view-categories-title', 'nl', 'Categories');
...
INSERT INTO `text` VALUES('project-view-metter-days', 'nl', 'Remaining');
INSERT INTO `text` VALUES('project-view-metter-days', 'en', 'Remaining');
INSERT INTO `text` VALUES('project-view-metter-got', 'ca', 'Obtingut');
INSERT INTO `text` VALUES('project-view-metter-got', 'nl', 'Received');
...
INSERT INTO `text` VALUES('project-view-metter-investment', 'nl', 'Co-financing');
...
INSERT INTO `text` VALUES('project-view-metter-investors', 'nl', 'Co-financiers');
...
INSERT INTO `text` VALUES('project-view-metter-minimum', 'nl', 'Minimum');
...
INSERT INTO `text` VALUES('project-view-metter-optimum', 'nl', 'Optimum');
...
INSERT INTO `text` VALUES('recover-email-sended', 'nl', 'We have sent you an email with instructions for recovering your password. If you don''t get it right away, be sure to check your junk or spam folders.');
...
INSERT INTO `text` VALUES('recover-request-fail', 'nl', 'We could not recover the password from any account with that data');
...
INSERT INTO `text` VALUES('recover-token-incorrect', 'nl', 'The code for recovering your password is not valid');
...
INSERT INTO `text` VALUES('register-confirm_mail-fail', 'nl', 'There has been an error when sending the account activation email. Please contact us at %s');
...
INSERT INTO `text` VALUES('register-confirm_mail-success', 'nl', 'Account activation message sent. If it you don''t find it on your Inbox, check your /Spam folder.');
...
INSERT INTO `text` VALUES('regular-facebook-url', 'nl', 'http://www.facebook.com/');
...
INSERT INTO `text` VALUES('regular-footer-contact', 'nl', 'Contact');
...
INSERT INTO `text` VALUES('regular-footer-legal', 'nl', 'Legal terms');
...
INSERT INTO `text` VALUES('regular-footer-privacy', 'nl', 'Privacy policy');
...
INSERT INTO `text` VALUES('regular-header-glossary', 'nl', 'Glossary of terms used in Goteo');
...
INSERT INTO `text` VALUES('regular-invest_it', 'nl', 'Co-finance this project');
...
INSERT INTO `text` VALUES('regular-message_fail', 'nl', 'There was an error sending the message');
...
INSERT INTO `text` VALUES('regular-share-facebook', 'nl', 'Goteo on Facebook');
INSERT INTO `text` VALUES('regular-share-facebook', 'en', 'Goteo on Facebook');
INSERT INTO `text` VALUES('regular-share-rss', 'ca', 'RSS/BLOG');
INSERT INTO `text` VALUES('regular-share-rss', 'nl', 'RSS/Blog');
...
INSERT INTO `text` VALUES('regular-share-twitter', 'nl', 'Follow us on Twitter');
...
INSERT INTO `text` VALUES('regular-weeks', 'nl', 'weeks');
INSERT INTO `text` VALUES('regular-weeks', 'en', 'weeks');
INSERT INTO `text` VALUES('regular-yes', 'ca', 'Sí');
INSERT INTO `text` VALUES('regular-yes', 'nl', 'Yes');
...
INSERT INTO `text` VALUES('review-ajax-alert', 'nl', 'Evaluation / feedback fields will be automatically updated when changed');
...
INSERT INTO `text` VALUES('review-closed-alert', 'nl', 'You marked the review as finished, no more changes can be done.');
...
INSERT INTO `text` VALUES('rewards-field-individual_reward-amount', 'nl', 'Amount financed');
...
INSERT INTO `text` VALUES('rewards-field-individual_reward-description', 'nl', 'Description');
...
INSERT INTO `text` VALUES('rewards-field-individual_reward-other', 'nl', 'Specify the type of reward');
...
INSERT INTO `text` VALUES('rewards-field-individual_reward-reward', 'nl', 'Reward');
...
INSERT INTO `text` VALUES('rewards-field-individual_reward-type', 'nl', 'Type of reward');
...
INSERT INTO `text` VALUES('rewards-field-individual_reward-units', 'nl', 'Units');
...
INSERT INTO `text` VALUES('rewards-field-social_reward-description', 'nl', 'Description');
...
INSERT INTO `text` VALUES('rewards-field-social_reward-license', 'nl', 'Licensing options');
...
INSERT INTO `text` VALUES('rewards-field-social_reward-other', 'nl', 'Specify the type of benefit');
...
INSERT INTO `text` VALUES('rewards-field-social_reward-reward', 'nl', 'Benefits');
...
INSERT INTO `text` VALUES('rewards-field-social_reward-type', 'nl', 'Type of benefit');
...
INSERT INTO `text` VALUES('rewards-fields-individual_reward-title', 'nl', 'Individual rewards');
...
INSERT INTO `text` VALUES('rewards-fields-social_reward-title', 'nl', 'Collective benefits');
...
INSERT INTO `text` VALUES('rewards-main-header', 'nl', 'Benefits and rewards');
...
INSERT INTO `text` VALUES('social-account-facebook', 'nl', 'http://www.facebook.com/pages/Goteo/268491113192109');
...
INSERT INTO `text` VALUES('social-account-google', 'nl', 'https://plus.google.com/b/116559557256583965659/');
...
INSERT INTO `text` VALUES('social-account-identica', 'nl', 'http://identi.ca/goteofunding');
INSERT INTO `text` VALUES('social-account-identica', 'en', 'http://identi.ca/goteofunding');
INSERT INTO `text` VALUES('social-account-linkedin', 'nl', 'Goteo page at Linkedin');
...
INSERT INTO `text` VALUES('step-overview', 'nl', 'Step 3: Project description');
...
INSERT INTO `text` VALUES('step-preview', 'nl', 'Project / Preview');
INSERT INTO `text` VALUES('step-preview', 'en', 'Project / Preview');
INSERT INTO `text` VALUES('step-rewards', 'ca', 'Pas 5: Projecte / Retorns');
INSERT INTO `text` VALUES('step-rewards', 'nl', 'Step 5: Project / Benefits');
...
INSERT INTO `text` VALUES('step-supports', 'nl', 'Step 6: Project / Collaborations');
...
INSERT INTO `text` VALUES('step-userPersonal', 'nl', 'Step 2: Personal information');
...
INSERT INTO `text` VALUES('step-userProfile', 'nl', 'Step 1: User / Profile');
...
INSERT INTO `text` VALUES('supports-fields-support-title', 'nl', 'Collaborations');
...
INSERT INTO `text` VALUES('supports-main-header', 'nl', 'Request for collaborations');
...
INSERT INTO `text` VALUES('tooltip-dashboard-user-access_data', 'nl', 'This is your current log in data. The only thing you cannot change is your username.');
...
INSERT INTO `text` VALUES('tooltip-dashboard-user-change_email', 'nl', 'Change the email address at which you receive messages from Goteo.');
...
INSERT INTO `text` VALUES('tooltip-dashboard-user-change_password', 'nl', 'Change your password that you use to log in to Goteo.');
...
INSERT INTO `text` VALUES('tooltip-dashboard-user-confirm_email', 'nl', 'Confirm the new email address where you wish to receive messages from Goteo.');
...
INSERT INTO `text` VALUES('tooltip-dashboard-user-confirm_password', 'nl', 'Confirm the new password with which you want to log in to Goteo.');
...
INSERT INTO `text` VALUES('tooltip-dashboard-user-user_password', 'nl', 'Write the current password that you use to log in to Goteo');
...
INSERT INTO `text` VALUES('tooltip-project-comment', 'nl', 'Do you have any doubts or comments for the Goteo administrator? This is the place to mention some part of what you have written that you''re not sure about, to suggest improvements, etc.');
...
INSERT INTO `text` VALUES('tooltip-project-contract_birthdate', 'nl', 'Enter your date of birth. It will never be published, but rather only used for statistical purposes.');
...
INSERT INTO `text` VALUES('tooltip-project-contract_data', 'nl', 'Whether it''s a person or legal entity, someone has to be named as the project promoter, as well as the liaison with the Goteo team. It doesn''t have to be the same as the user profile from the previous field.');
...
INSERT INTO `text` VALUES('tooltip-project-contract_email', 'nl', 'Main email address associated with the project.You will receive all the notifications and messages from the Goteo team relating to your project proposal at this address.');
...
INSERT INTO `text` VALUES('tooltip-project-contract_entity', 'nl', 'Choose “Person” if you are the project promoter and are representing yourself. If the promoter is a group you have to choose the second option, “Legal Entity”, in which case, you''ll also have to enter a CIF.');
...
INSERT INTO `text` VALUES('tooltip-project-contract_name', 'nl', 'Please use your real first name and surname. Note that you will be listed as the project leader.');
...
INSERT INTO `text` VALUES('tooltip-project-contract_nif', 'nl', 'Your NIF, NIE or VAT number with digits and the letter');
...
INSERT INTO `text` VALUES('tooltip-project-cost-amount', 'nl', 'Specify the amount in euros for each expense. Don''t use points or commas to mark the thousands, OK?');
...
INSERT INTO `text` VALUES('tooltip-project-cost-cost', 'nl', 'Enter the most descriptive title possible for this expense');
...
INSERT INTO `text` VALUES('tooltip-project-cost-description', 'nl', 'Briefly explain what this expense consists of.');
...
INSERT INTO `text` VALUES('tooltip-project-cost-type', 'nl', 'Here you should specify the type of expense: related to a task (something that requires someone''s skill or knowledge), obtaining material (consumables, raw materials) or infrastructure (spaces, equipment, furniture) ');
...
INSERT INTO `text` VALUES('tooltip-project-cost-type-material', 'nl', 'Necessary materials for the project, like tools, office material, computer equipment, etc.');
...
INSERT INTO `text` VALUES('tooltip-project-cost-type-structure', 'nl', 'Investment in costs that are linked to an office space or store front, mode of transport, or other basic infrastructure needed to bring the project to fruition.');
...
INSERT INTO `text` VALUES('tooltip-project-cost-type-task', 'nl', 'Tasks in which knowledge and skills can be invested in order to develop a part of the project.');
...
INSERT INTO `text` VALUES('tooltip-project-costs', 'nl', 'The more precisely you break down the expenses, the better Goteo will be able to evaluate the general information about your project.');
...
INSERT INTO `text` VALUES('tooltip-project-currently', 'nl', 'Which phase is the project currently in with respect to the process of creation or execution?');
...
INSERT INTO `text` VALUES('tooltip-project-description', 'nl', 'Describe the project in at least 80 words (any less will generate an error). Explain it so that it''s easy to understand for a lay person. Try to give it an attractive, social focus, summarizing its strong points that make it unique, innovative or special. ');
...
INSERT INTO `text` VALUES('tooltip-project-entity_cif', 'nl', 'Enter the organization''s business number (CIF, letter plus the number)');
...
INSERT INTO `text` VALUES('tooltip-project-entity_name', 'nl', 'Write the name of the organization exactly as it appears in its CIF.');
...
INSERT INTO `text` VALUES('tooltip-project-entity_office', 'nl', 'Enter the position with which you represent the organization (secretary, president, ...)');
...
INSERT INTO `text` VALUES('tooltip-project-individual_reward-amount', 'nl', 'Amount for which one can receive this type of reward.');
...
INSERT INTO `text` VALUES('tooltip-project-individual_reward-description', 'nl', 'Briefly explain what the reward will consist of for those who co-finance the project at this level.');
...
INSERT INTO `text` VALUES('tooltip-project-individual_reward-icon-other', 'nl', 'Briefly describe this other type of individual reward');
...
INSERT INTO `text` VALUES('tooltip-project-individual_reward-reward', 'nl', 'Try to make the title as descriptive as possible. Remember that you can add more rewards later.');
...
INSERT INTO `text` VALUES('tooltip-project-individual_reward-type', 'nl', 'Select the type of reward that the project can offer to people who contribute this amount.');
...
INSERT INTO `text` VALUES('tooltip-project-individual_reward-units', 'nl', 'Limited quantity of items that can be offered individually in exchange for this amount. Adjust the amounts so that the total sum of all of the individual rewards for the project is close to the minimum financing budget that you have created. Don''t forget that you can also incorporate the previous rewards as the amount increases, by starting with “All of the preceding, plus...”');
...
INSERT INTO `text` VALUES('tooltip-project-keywords', 'nl', 'As you enter text, the system will suggest key words that other users have written. These categories help to link your project with other similar ones.');
...
INSERT INTO `text` VALUES('tooltip-project-lang', 'nl', 'Indicate the language in which you''re filling out the project form.');
...
INSERT INTO `text` VALUES('tooltip-project-main_address', 'nl', 'Legal address of the person or organization (whichever applies)');
...
INSERT INTO `text` VALUES('tooltip-project-motivation', 'nl', 'Explain the reasons or circumstances that led you do think of this project, as well as the communities or users to whom it is geared. It will help you connect with people who are moving in this same circle of interests, problems, and tastes.');
...
INSERT INTO `text` VALUES('tooltip-project-name', 'nl', 'Enter a title for your project. The shorter the better, you can add description in the following field.');
...
INSERT INTO `text` VALUES('tooltip-project-nsupport', 'nl', 'Advice on filling out a new collaboration proposal');
...
INSERT INTO `text` VALUES('tooltip-project-phone', 'nl', 'Telephone number (mobile or landline) with prefix');
...
INSERT INTO `text` VALUES('tooltip-project-post_address', 'nl', 'Indicate, if need be, a detailed postal address');
...
INSERT INTO `text` VALUES('tooltip-project-project_location', 'nl', 'Indicate where the project will be developed; in which towns or cities the principal promoters are located.');
...
INSERT INTO `text` VALUES('tooltip-project-related', 'nl', 'Summarize how you or the promoting group got to this point. What experience do you have that relates to the proposal? Tell us about your team, resources, and infrastructure. ');
...
INSERT INTO `text` VALUES('tooltip-project-resource', 'nl', 'Note here if you are counting on additional resources, apart from those that you''re asking for, in order to carry out this project: sources of financing, your own resources, or perhaps you''ve already gathered some materials. This might be attractive to potential co-financiers of your project.');
...
INSERT INTO `text` VALUES('tooltip-project-schedule', 'nl', 'Production calendar for your project. Remember that you should only indicate new tasks, not those that have already been completed.');
...
INSERT INTO `text` VALUES('tooltip-project-scope', 'nl', 'Specify the geographic impact that you hope this project will have (each category includes the previous one)');
...
INSERT INTO `text` VALUES('tooltip-project-social_reward-description', 'nl', 'Briefly explain the type of collective benefit that this project will offer or allow.');
...
INSERT INTO `text` VALUES('tooltip-project-social_reward-icon-other', 'nl', 'Briefly describe what this other collective benefit consists of');
...
INSERT INTO `text` VALUES('tooltip-project-social_reward-license', 'nl', 'Choose a license from the group displayed. We recommend that you read through them carefully before deciding, and keep in mind that an important factor for Goteo is that projects have the most open licences possible.');
...
INSERT INTO `text` VALUES('tooltip-project-social_reward-reward', 'nl', 'Try to make the title as descriptive as possible. Remember that you can add more benefits later.');
...
INSERT INTO `text` VALUES('tooltip-project-social_rewards', 'nl', 'Define the type of benefits from the project that can be accessed openly, and the license that should regulate them. If you have any doubts about which option to choose, or which is best in your case, <a href="http://www.goteo.org/contact" target="new">contact us</a> and we will advise you on this point.');
...
INSERT INTO `text` VALUES('tooltip-project-subtitle', 'nl', 'Create a single phrase for the subtitle that explains just what your initiative is about, that gives a taste of what it''s for and what it consists of. It will appear together with the project title.');
...
INSERT INTO `text` VALUES('tooltip-project-support', 'nl', 'Advice on editing existing collaborations');
...
INSERT INTO `text` VALUES('tooltip-project-support-description', 'nl', 'Briefly explain the kind of help that your project needs, to help people see what is needed and encourage them to collaborate.');
...
INSERT INTO `text` VALUES('tooltip-project-support-support', 'nl', 'Descriptive title about the needed collaboration');
...
INSERT INTO `text` VALUES('tooltip-project-support-type', 'nl', 'Choose if the project needs help with concrete tasks or rather loans of material, infrastructure, etc.');
...
INSERT INTO `text` VALUES('tooltip-project-support-type-lend', 'nl', 'Temporary loan of material needed for the project, or the loan of infrastructure or space during a given period of time. It might also imply permanent loans, that is, gifts :)');
...
INSERT INTO `text` VALUES('tooltip-project-support-type-task', 'nl', 'This collaboration requires a skill in a specific task, either via computer or in person.');
...
INSERT INTO `text` VALUES('tooltip-project-supports', 'nl', 'In Goteo, projects can be supported in other ways besides just monetary. There are people who can''t help economically but have plenty to offer in terms of their talent, time, energy, and more.');
...
INSERT INTO `text` VALUES('tooltip-project-usubs', 'nl', 'Check if you subtitled the video to other languages with Universal Subtitles: http://www.universalsubtitles.org/');
...
INSERT INTO `text` VALUES('tooltip-user-about', 'nl', 'As a social network, Goteo attempts to help spread the word about and finance interesting projects among the largest amount of people possible. To that end, it''s important to share information about your skills and experience (professional, academic, hobbies, etc.)');
...
INSERT INTO `text` VALUES('tooltip-user-contribution', 'nl', 'Briefly explain your skills and the areas in which you could help (translating, marketing, testing, programming, teaching, etc.)');
...
INSERT INTO `text` VALUES('tooltip-user-facebook', 'nl', 'This social network can help you spread the word about Goteo projects that interest you with your friends and family.');
...
INSERT INTO `text` VALUES('tooltip-user-google', 'nl', 'The Google+ social network is pretty new, but you can specify your user id if you use it already.');
...
INSERT INTO `text` VALUES('tooltip-user-identica', 'nl', 'This channel can help you spread the word about Goteo projects in the open source community.');
...
INSERT INTO `text` VALUES('tooltip-user-image', 'nl', 'You don''t have to add a profile picture, but it does help other users to identify you.');
...
INSERT INTO `text` VALUES('tooltip-user-interests', 'nl', 'Indicate the kind of projects you might be interested in co-financing or in supporting with other resources, knowledge or skills. These categories cut across boundaries; you can select more than one.');
...
INSERT INTO `text` VALUES('tooltip-user-keywords', 'nl', 'As you enter text, the system will suggest key words that have already been created by other users. These categories help link your profile with specific other people and projects.');
...
INSERT INTO `text` VALUES('tooltip-user-linkedin', 'nl', 'This social network can help you spread the word about interesting Goteo projects with your professional contacts.');
...
INSERT INTO `text` VALUES('tooltip-user-location', 'nl', 'This information is important so that we can connect you with a local Goteo group.');
...
INSERT INTO `text` VALUES('tooltip-user-name', 'nl', 'Your screen name or nickname on Goteo. You can change it whenever you like. (Note: it''s not the same as your user name, which cannot be changed.)');
...
INSERT INTO `text` VALUES('tooltip-user-twitter', 'nl', 'This social network can help spread the word about Goteo projects quickly and virally.');
...
INSERT INTO `text` VALUES('tooltip-user-webs', 'nl', 'Indicate the URL addresses of personal or other websites that you are associated with.');
...
INSERT INTO `text` VALUES('translate-home-guide', 'nl', 'Note to the translator');
...
INSERT INTO `text` VALUES('user-account-inactive', 'nl', 'The account is deactivated.');
...
INSERT INTO `text` VALUES('user-activate-already-active', 'nl', 'The account is already active.');
...
INSERT INTO `text` VALUES('user-activate-fail', 'nl', 'Error upon activating the user account');
...
INSERT INTO `text` VALUES('user-activate-success', 'nl', 'The account has been activated correctly.');
...
INSERT INTO `text` VALUES('user-changeemail-fail', 'nl', 'Error while changing the email');
...
INSERT INTO `text` VALUES('user-changeemail-success', 'nl', 'The email address has been successfully changed.');
...
INSERT INTO `text` VALUES('user-changeemail-title', 'nl', 'Change email');
...
INSERT INTO `text` VALUES('user-changepass-confirm', 'nl', 'Confirm new password');
...
INSERT INTO `text` VALUES('user-changepass-new', 'nl', 'New password');
...
INSERT INTO `text` VALUES('user-changepass-old', 'nl', 'Current password');
...
INSERT INTO `text` VALUES('user-changepass-title', 'nl', 'Change password');
...
INSERT INTO `text` VALUES('user-email-change-sended', 'nl', 'We have sent you an email so that you can confirm the change of address');
...
INSERT INTO `text` VALUES('user-login-required', 'nl', 'You have to sign in to interact with the Goteo community');
...
INSERT INTO `text` VALUES('user-login-required-access', 'nl', 'You have to sign in or ask for permission to get access to this section');
...
INSERT INTO `text` VALUES('user-login-required-to_create', 'nl', 'You have to sign in to create a project');
...
INSERT INTO `text` VALUES('user-login-required-to_invest', 'nl', 'You have to sign in to co-finance a project');
...
INSERT INTO `text` VALUES('user-login-required-to_message', 'nl', 'You have to sign in to send messages');
...
INSERT INTO `text` VALUES('user-login-required-to_see', 'nl', 'You have to sign in to see this page');
...
INSERT INTO `text` VALUES('user-login-required-to_see-supporters', 'nl', 'You have to sign in to see the other co-financiers');
...
INSERT INTO `text` VALUES('user-message-send_personal-header', 'nl', 'Send a message to the user');
...
INSERT INTO `text` VALUES('user-password-changed', 'nl', 'You have changed your password');
...
INSERT INTO `text` VALUES('user-personal-saved', 'nl', 'Updated personal information');
...
INSERT INTO `text` VALUES('user-prefer-saved', 'nl', 'Your notification preferences were saved correctly');
...
INSERT INTO `text` VALUES('user-preferences-mailing', 'nl', 'Disable newsletter subscription');
...
INSERT INTO `text` VALUES('user-preferences-rounds', 'nl', 'Disable progress notifications from the projects I''m backing');
...
INSERT INTO `text` VALUES('user-preferences-threads', 'nl', 'Disable answer notifications to the messages I start');
...
INSERT INTO `text` VALUES('user-preferences-updates', 'nl', 'Disable news notifications from the projects I''m backing');
...
INSERT INTO `text` VALUES('user-profile-saved', 'nl', 'Profile updated');
...
INSERT INTO `text` VALUES('user-register-success', 'nl', 'The user was registered correctly. We are sending you an activation email now.');
...
INSERT INTO `text` VALUES('user-save-fail', 'nl', 'There was a problem saving the data');
...
INSERT INTO `text` VALUES('validate-cost-field-dates', 'nl', 'Specify the beginning and ending dates for the expense in order to better evaluate the project.');
...
INSERT INTO `text` VALUES('validate-project-costs-any_error', 'nl', 'Some information is missing from the breakdown of the expense');
...
INSERT INTO `text` VALUES('validate-project-field-about', 'nl', 'The project description is too short');
...
INSERT INTO `text` VALUES('validate-project-field-costs', 'nl', 'We recommend that you break it down into least 5 distinct expenses to make it easier to evaluate your project to see whether it should be published on Goteo.');
...
INSERT INTO `text` VALUES('validate-project-field-currently', 'nl', 'Indicate the current status of the project in order to facilitate the evaluation of the project and to determine whether it should be published on Goteo.');
...
INSERT INTO `text` VALUES('validate-project-field-description', 'nl', 'The project description is too short');
...
INSERT INTO `text` VALUES('validate-project-individual_rewards', 'nl', 'Indicate up to 5 individual rewards in order to improve the score');
...
INSERT INTO `text` VALUES('validate-project-individual_rewards-any_error', 'nl', 'Some information about individual rewards is missing.');
...
INSERT INTO `text` VALUES('validate-project-social_rewards', 'nl', 'You have to specify at least one collective benefit');
...
INSERT INTO `text` VALUES('validate-project-social_rewards-any_error', 'nl', 'Some information is missing about collective benefits.');
...
INSERT INTO `text` VALUES('validate-project-total-costs', 'nl', 'The optimal cost cannot exceed the minimum cost by more than 50%. You have to either raise the essential costs or lower the supplemental costs. ');
...
INSERT INTO `text` VALUES('validate-project-userProfile-any_error', 'nl', 'There''s an error in the URL address');
...
INSERT INTO `text` VALUES('validate-project-userProfile-web', 'nl', 'We recommend you list some websites');
...
INSERT INTO `text` VALUES('validate-project-value-contract_email', 'nl', 'The email address is incorrect.');
...
INSERT INTO `text` VALUES('validate-project-value-contract_nif', 'nl', 'The NIF is incorrect');
...
INSERT INTO `text` VALUES('validate-project-value-description', 'nl', 'The project description is too short');
...
INSERT INTO `text` VALUES('validate-project-value-entity_cif', 'nl', 'The Business number (CIF) is not valid.');
...
INSERT INTO `text` VALUES('validate-project-value-keywords', 'nl', 'Write down at least five key words about the project that will help facilitate its evaulation by Goteo.');
...
INSERT INTO `text` VALUES('validate-project-value-phone', 'nl', 'The format of the telephone number is incorrect');
...
INSERT INTO `text` VALUES('validate-register-value-email', 'nl', 'The email address you entered is not valid');
...
INSERT INTO `text` VALUES('validate-social_reward-license', 'nl', 'Indicate a license in order to improve the score');
...
INSERT INTO `text` VALUES('validate-user-field-about', 'nl', 'Tell us about yourself so that we can better evaluate your project and determine its suitability for publishing on Goteo.');
...
INSERT INTO `text` VALUES('validate-user-field-avatar', 'nl', 'Add a profile image to help us evaluate your project and determine whether it is suitable for publication on Goteo.');
...
INSERT INTO `text` VALUES('validate-user-field-contribution', 'nl', 'Explain what you could bring to Goteo to improve the evaluation of the project to determine whether it should be published on the platform.');
...
INSERT INTO `text` VALUES('validate-user-field-facebook', 'nl', 'Add your Facebook user name to help us evaluate your project and whether it is suitable for publication on Goteo.');
...
INSERT INTO `text` VALUES('validate-user-field-interests', 'nl', 'Select an interest to help us evaluate your project and determine if it is suitable for publication on Goteo.');
...
INSERT INTO `text` VALUES('validate-user-field-keywords', 'nl', 'Indicate up to 5 key words that define you, to help evaluate your project and decide if it is suitable for publication on Goteo.');
...
INSERT INTO `text` VALUES('validate-user-field-linkedin', 'nl', 'The LinkedIn field is not valid');
...
INSERT INTO `text` VALUES('validate-user-field-location', 'nl', 'The place of residence of the user is not valid');
...
INSERT INTO `text` VALUES('validate-user-field-name', 'nl', 'Enter your complete name to help us evaluate your project and see whether it is suitable for publishing on Goteo.');
...
INSERT INTO `text` VALUES('validate-user-field-twitter', 'nl', 'The Twitter user name is not valid');
...
INSERT INTO `text` VALUES('validate-user-field-web', 'nl', 'Please enter the address (URL) of the website');
...
INSERT INTO `text` VALUES('validate-user-field-webs', 'nl', 'Enter the address of your website to help us evaluate your project and determine if it is suitable for publishing on Goteo.');
